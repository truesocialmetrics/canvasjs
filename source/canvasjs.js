/**
* @preserve CanvasJS HTML5 & JavaScript Charts - v1.9.7 GA - http://canvasjs.com/ 
...
(function () {
	...
	var numberFormat = function (v, fs, cultureInfo) {
		...
		if (isScientificNotation) {
			...
			exponent = v === 0 ? "" : (integer === 0 ? "" : String(integer)).length - noPhBeforeDecimal;
	...
	CanvasJS.Chart.version = "v1.9.7 GA";
